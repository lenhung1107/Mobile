...
class MainActivity : AppCompatActivity() {
  ...
  val students = mutableListOf(
    StudentModel("Đỗ Thùy Dương", "20215019"),
    StudentModel("Đinh Minh Ánh", "20214991"),
    StudentModel("Hà Quỳnh Trang", "20210852"),
    StudentModel("Phạm Vân Anh", "20214988"),
    StudentModel("Đặng Hải Mai Linh", "20210658")
  )

  // Khởi tạo Adapter cho ListViewa
